...
export const TUTORIAL_STEPS=[
 ...
 {id:'sprint',action:'sprint',title:'奔跑脱身',detail:'按住 Shift 奔跑 4 米',target:4,key:'SHIFT'},
 {id:'shoot',action:'shoot',title:'挥出轻击',detail:'按左键或 J 打出一次近战轻击',target:1,key:'左键 / J'},
 {id:'hit',action:'hit',title:'命中目标',detail:'用轻击或枪械命中一名未感染者',target:1,key:'瞄准攻击'},
